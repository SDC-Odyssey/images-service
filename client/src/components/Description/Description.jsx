...
import { Container, OuterContainer, DescriptionContainer, DescriptionList, ReviewsContainer, DescriptionListItem, StarSvg, Rating, ReviewCount, SuperHostSvg, SuperHostText, Location, ShareSvg, ShareText, HeartSvg, SaveText } from './style.Description.jsx';
...
const Description = (props) => {
  ...
  // }
  const superHost = 'Superhost';
  const location = faker.lorem.sentence({'word_count': 3}); //not working, putting .
